export default function Resume() {
    return (
        <main>
            ...
            <ul>
                <li>Collaborated successfully with theatrical companies ranging from 4 to 50 cast members, frequently in high stress environments requiring flexibility and adaptability</li>
                <li>Learned multiple roles in a single production, providing flexibility to the production team</li>
